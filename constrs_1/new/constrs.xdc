...
set_property PACKAGE_PIN R3 [get_ports {store[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {store[0]}]
set_property PACKAGE_PIN W2 [get_ports {store[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {store[1]}]
